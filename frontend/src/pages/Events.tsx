        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col md:flex-row gap-4 max-w-4xl items-start">
            ...
            <div className="relative flex-1 w-full md:max-w-md">
              <Search className="absolute left-3 top-3.5 text-gray-400 dark:text-gray-500 w-5 h-5 pointer-events-none" />
              <input 
                type="text" 
                placeholder="Search events..." 
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-brand-darkCard text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-brand-darkText rounded-xl border border-gray-200 dark:border-brand-darkBorder focus:outline-none focus:ring-2 focus:ring-brand-blue/50 shadow-sm transition-colors h-full min-h-[42px]"
              />
            </div>
